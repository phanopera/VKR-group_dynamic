...
public class ChangeStress : MonoBehaviour
{
    ...
    // Îïðåäåëåíèå êëàññà StressState
    ...
    //---ÄËß ÒÅÑÒÀ 10 ÑÒÐÅÑÑÎÂÛÕ ÑÈÒÓÀÖÈÉ
